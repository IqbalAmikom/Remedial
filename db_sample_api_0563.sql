...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 17, 2022 at 05:30 AM
...
CREATE TABLE `tbl_students_0563` (
  ...
  `prodi` varchar(75) DEFAULT NULL,
  `asal` varchar(110) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_students_0563`
--

INSERT INTO `tbl_students_0563` (`id`, `nim`, `nama`, `jk`, `prodi`, `asal`) VALUES
